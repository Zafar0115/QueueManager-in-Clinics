    ...
    public partial class init21 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ClinicsClinicId = table.Column<Guid>(type: "uuid", nullable: false),
                    DoctorsDoctorId = table.Column<Guid>(type: "uuid", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClinicDoctor", x => new { x.ClinicsClinicId, x.DoctorsDoctorId });
                    table.ForeignKey(
                        name: "FK_ClinicDoctor_Clinics_ClinicsClinicId",
                        column: x => x.ClinicsClinicId,
                        principalTable: "Clinics",
                        principalColumn: "ClinicId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ClinicDoctor_Doctors_DoctorsDoctorId",
